...
A 24/7 biohacker physiology lab + cycling-training brain for Android (Kotlin · Jetpack Compose). Real RMSSD HRV from a BLE chest strap, cortisol-awakening-response detection, orthostatic testing, and a live on-bike HUD with physics-model power estimates. The bet is **integration + transparency + sovereignty** — transparent formulas, source sensors exposed, and raw signal that never leaves your device.
...
### 💥 [redos](https://github.com/gazzycodes/redos) · *public · open source*
